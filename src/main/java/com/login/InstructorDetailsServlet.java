    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (instructorIdStr != null && !instructorIdStr.isEmpty()) {
            try {
                ...
                List<Map<String, Object>> instructorDetails = instructorDao.getInstructorDetails(Integer.parseInt(instructorIdStr));

                Gson gson = new Gson();
                String json = gson.toJson(instructorDetails);
                ...
                out.print(getErrorJson("An error occurred while fetching instructor details."));
            } finally {
                out.flush();
                out.close();
            }
